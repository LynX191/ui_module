...
Item {
    ...
    Item{ // Button control Carton Loader
        width: parent.width
        ...
        GridLayout{
            ...
            rowSpacing: 0
            Repeater{
                // model: ["Tray Clamp","Tray Tilt","Tray Tilt & Clamp","Push Out Box","Carton Loader I/O"]
                model: ["Carton Loader I/O", "Parameters"]
                ...
                delegate: Item{
                    ...
                    Button{
                        ...
                        onClicked: {
                            ...
                            switch(index){
                                // case 0: stationVM.clTrayClamp() 
                                //     break
                                // case 1: stationVM.clTrayTilt() 
                                //     break
                                // case 2: stationVM.clTrayTiltAndClamp() 
                                //     break
                                // case 3: stationVM.clTrayPushOutBox() 
                                //     break
